...
**1.6** Você concorda que terá que enviar autorização por escrito no e-mail `666ravena.js@gmail.com` referente ao `TCLE & Privacidade` além da aceitação digital referente as aplicações, [clique aqui baixar a autorização por escrito](https://transfer.sh/bAoKU1/autorização.pdf).
> Quando for enviar o e-mail na parte "assunto" informe o seu ID do Discord.
